...
class KioskManagerWindow(Gtk.Window):
    ...
    def _build_ui(self):
        ...
        # Pi Boot Screen
        pi_box = Gtk.Box(spacing=0)
        pi_box.set_margin_start(12)
        ...
        self.pi_splash_check.set_tooltip_text(
            "Suppress the rainbow splash and Pi logo that\n"
            "appear before the boot image. Your custom boot\n"
            "image will show from the very start of boot.")
        pi_box.pack_start(self.pi_splash_check, False, False, 0)
        boot_page.pack_start(pi_box, False, False, 0)
